...
if os.environ.get('LOCAL_DEV', 'True') == 'False':
    ...
    DATABASES = {
        'default': {
            ...
            'NAME': join(ROOT_PATH, 'pj.db'),                      # Or path to database file if using sqlite3.
...
SECRET_KEY = '$3x1$!jhg4q%772075&amp;a9$0!l%1r0%j$lhqp3c0j_4=lnh@0za'
